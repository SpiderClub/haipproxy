...
"""
from haipproxy.settings import SPIDER_AJAX_Q, SPIDER_GFW_Q, SPIDER_AJAX_GFW_Q
...
CRAWLER_TASKS = [
    ...
    },
    {
        ...
        "resource": ["https://www.socks-proxy.net/"],
        "parse_type": "common",
        "parse_rule": {
    ...
    },
    {
        ...
        "parse_type": "common",
        "parse_rule": {"detail_rule": "a::text", "split_detail": True},
        "interval": 3 * 60,
        "enable": 1,
    },
    {
    ...
    },
    {
        ...
        "resource": [
            "http://free-proxy.cz/en/proxylist/main/%s" % i for i in range(1, 30)
        ],
